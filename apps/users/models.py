...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(
        max_length=255, verbose_name=_("Username"), unique=True, db_index=True
    )
    phone = models.CharField(
        max_length=12, verbose_name=_("Phone number"), unique=True, db_index=True
    )
    ...
    middle_name = models.CharField(
        max_length=50, verbose_name=_("Last name"), null=True
    )
